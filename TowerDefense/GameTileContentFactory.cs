...
public class GameTileContentFactory : GameObjectFactory
{
    ...
    {
        Debug.Assert((int)type < towerPrefab.Length, "tower type not defined");
        Tower prefab = towerPrefab[(int)type];
        Debug.Assert(prefab.TowerType == type, "tower type at wrong index");
        return Get(prefab);
    }
